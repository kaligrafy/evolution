...
type AssertUuidKeyedSurveyObjectCoverage =
    UuidKeyedSurveyObjectName extends keyof typeof reviewUuidKeyedCollectionKeysByObjectType
        ? keyof typeof reviewUuidKeyedCollectionKeysByObjectType extends UuidKeyedSurveyObjectName
            ? true
            : never
        : never;
const _assertUuidKeyedSurveyObjectCoverage: AssertUuidKeyedSurveyObjectCoverage = true;
void _assertUuidKeyedSurveyObjectCoverage;
void surveyObjectNames;
